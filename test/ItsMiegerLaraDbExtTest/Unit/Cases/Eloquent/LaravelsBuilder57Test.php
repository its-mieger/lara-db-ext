<?php
	...
	/**
	 * This test class is copied from Laravel's DatabaseEloquentBuilderTest (v5.7) to ensure core functionality is not broken by this extension
...
//		}
		...
		public function testMissingStaticMacrosThrowsProperException() {
			$this->expectExceptionMessageRegExp('/^Call to undefined method .*?Builder::missingMacro\(\)$/');
