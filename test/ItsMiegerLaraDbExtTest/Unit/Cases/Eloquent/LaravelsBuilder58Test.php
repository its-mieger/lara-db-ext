...
use ItsMieger\LaraDbExt\Eloquent\Builder;
...
/**
 * This test class is copied from Laravel's DatabaseEloquentBuilderTest (v5.8) to ensure core functionality is not broken by this extension
 * @package ItsMiegerLaraDbExtTest\Unit\Cases\Eloquent
 */
...
//	}
	...
	public function testGlobalMacrosAreCalledOnBuilder() {
		...
		Builder::macro('bam', [\Illuminate\Database\Eloquent\Builder::class, 'getQuery']);
	...
	public function testMissingStaticMacrosThrowsProperException() {
		...
		$this->expectExceptionMessage('Call to undefined method ItsMieger\LaraDbExt\Eloquent\Builder::missingMacro()');
